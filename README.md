...
Full index: [**`docs/README.md`**](docs/README.md). It is also the API documentation: `cargo doc --workspace --no-deps --open` renders every page below onto the crate that implements it.
