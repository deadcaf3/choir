...
- `choir triage <api>` — every review and change classified into a bucket — landed, awaiting verdicts, changes requested, approved-but-target-moved — ranked most-actionable-first, capped, with truncation marked in-band
